...
import com.ibailian.android.demo.R;
...
//	private String mLastUpdateTime;
	...
	public void onHeaderRefreshComplete() {
		...
		String time = DateUtils.getCurrentTime("yy-MM-dd HH:mm:ss");
		String time_new = time.substring(3);
		mHeaderUpdateTextView.setText("更新于:" + time_new);
		mHeaderState = PULL_TO_REFRESH;
	}
